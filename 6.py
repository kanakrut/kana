...
for point in range(0,641,64):
    pygame.draw.line(background, (255,255,255), (0,0), (400, point), 1) 
for point in range(0,641,64):
    pygame.draw.line(background, (255,0,255), (800,0), (400, point), 1)
for point in range(0,641,64): 
    pygame.draw.line(background, (0,128,0), (0,600), (400, point), 1)
for point in range(0,641,64): 
    pygame.draw.line(background, (255,255, 0), (800,600), (400, point), 1)
